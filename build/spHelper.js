...
var spHelper = function () {
    ...
    _createClass(spHelper, [{
        ...
        */
        ...
        key: 'getListDetails',
        value: function getListDetails(libraryName) {
            var readOnlyFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
            var onSuccessUser = arguments[2];
            var onFailureUser = arguments[3];
